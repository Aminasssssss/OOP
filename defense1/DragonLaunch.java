...
public class DragonLaunch {
    ...
    private Vector kidnappedPeople; 
    ...
    public boolean willDragonEatOrNot() {
        ...
        while (found) {
            ...
            for (int i = 0; i < kidnappedPeople.size() - 1; i++) {
                Person current = (Person) kidnappedPeople.get(i);
                Person next = (Person) kidnappedPeople.get(i + 1);
                
                if (current.getGender() == Gender.BOY && 
                    next.getGender() == Gender.GIRL) {
    ...
    public void displayLine() {
        ...
        for (int i = 0; i < kidnappedPeople.size(); i++) {
            Person p = (Person) kidnappedPeople.get(i);  
